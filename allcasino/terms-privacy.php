            ...
            <div class="casino-container">
                <div class="left-casino-container">
                    ...
                    <?php foreach ($companies as $company): ?>
                       ...
                       a                 <h4><?php echo get_field($country_code . '_company_benefit', $company->ID) != '' ? get_field($country_code . '_company_benefit', $company->ID) : get_field('company_benefit', $company->ID); ?></h4>
                                    </div>
